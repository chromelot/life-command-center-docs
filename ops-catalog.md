...
<!-- AUTO:HEALTH_REPORT -->
⚠ **15 issue(s)** across 125 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 47d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-07-23 14:14:28** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
