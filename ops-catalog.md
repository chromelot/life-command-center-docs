...
<!-- AUTO:HEALTH_REPORT -->
⚠ **15 issue(s)** across 128 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 56d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-08-01 10:46:04** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
