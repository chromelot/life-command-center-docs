...
<!-- AUTO:HEALTH_REPORT -->
⚠ **15 issue(s)** across 135 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 59d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-08-04 06:58:17** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
