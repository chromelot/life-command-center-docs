...
### stale (2)
- `context/self/current-priorities.md` — 27d old (threshold 14d)
- `context/systems/operations-catalog.md` — 103d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-09-16 19:24:50** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
