...
<!-- AUTO:HEALTH_REPORT -->
⚠ **15 issue(s)** across 146 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 77d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-08-22 15:15:18** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
