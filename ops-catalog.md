...
### stale (2)
- `context/self/current-priorities.md` — 19d old (threshold 14d)
- `context/systems/operations-catalog.md` — 95d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-09-09 14:51:13** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
