...
### stale (2)
- `context/self/current-priorities.md` — 16d old (threshold 14d)
- `context/systems/operations-catalog.md` — 92d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-09-06 17:34:30** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
