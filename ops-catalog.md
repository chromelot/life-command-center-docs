...
### stale (2)
- `context/self/current-priorities.md` — 31d old (threshold 14d)
- `context/systems/operations-catalog.md` — 107d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-09-21 15:06:29** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
