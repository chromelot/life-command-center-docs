...
<!-- AUTO:HEALTH_REPORT -->
⚠ **20 issue(s)** across 166 context files.

### stale (2)
- `context/self/current-priorities.md` — 29d old (threshold 14d)
- `context/systems/operations-catalog.md` — 105d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-09-19 11:09:48** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
