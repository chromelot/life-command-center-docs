...
### stale (2)
- `context/self/current-priorities.md` — 32d old (threshold 14d)
- `context/systems/operations-catalog.md` — 108d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-09-22 15:54:46** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
