...
### stale (2)
- `context/self/current-priorities.md` — 18d old (threshold 14d)
- `context/systems/operations-catalog.md` — 94d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-09-08 13:57:33** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
