...
<!-- AUTO:HEALTH_REPORT -->
⚠ **18 issue(s)** across 157 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 82d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-08-27 02:18:13** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
