...
<!-- AUTO:HEALTH_REPORT -->
⚠ **14 issue(s)** across 116 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 43d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-07-18 21:54:02** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
