...
<!-- AUTO:HEALTH_REPORT -->
⚠ **20 issue(s)** across 169 context files.

### stale (2)
- `context/self/current-priorities.md` — 34d old (threshold 14d)
- `context/systems/operations-catalog.md` — 110d old (threshold 30d)
...
- `context/systems/media-ingest-rotate.md` — no-frontmatter
...
- `context/work/systems/week-dashboard-v3-plan.md` — no-frontmatter
...
<!-- AUTO:LAST_GENERATED -->
**2026-09-23 20:18:49** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
