...
<!-- AUTO:HEALTH_REPORT -->
⚠ **5 issue(s)** across 77 context files.

### stale (1)
- `context/self/current-priorities.md` — 21d old (threshold 14d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-06-28 07:54:36** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
