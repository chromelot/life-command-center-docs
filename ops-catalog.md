...
<!-- AUTO:HEALTH_REPORT -->
⚠ **18 issue(s)** across 156 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 81d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-08-26 15:28:54** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
