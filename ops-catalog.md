...
<!-- AUTO:HEALTH_REPORT -->
⚠ **16 issue(s)** across 149 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 78d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-08-23 13:34:11** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
