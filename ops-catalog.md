...
<!-- AUTO:HEALTH_REPORT -->
⚠ **15 issue(s)** across 131 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 58d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-08-03 07:15:49** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
