...
<!-- AUTO:HEALTH_REPORT -->
⚠ **15 issue(s)** across 140 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 67d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-08-12 08:40:55** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
