...
<!-- AUTO:HEALTH_REPORT -->
⚠ **14 issue(s)** across 112 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 40d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-07-15 23:24:14** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
