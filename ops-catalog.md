...
<!-- AUTO:HEALTH_REPORT -->
⚠ **14 issue(s)** across 122 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 46d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-07-22 06:47:10** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
