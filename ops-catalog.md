...
<!-- AUTO:HEALTH_REPORT -->
⚠ **19 issue(s)** across 163 context files.

### stale (2)
- `context/self/current-priorities.md` — 25d old (threshold 14d)
- `context/systems/operations-catalog.md` — 101d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-09-15 13:12:43** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
