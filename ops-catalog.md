...
<!-- AUTO:HEALTH_REPORT -->
⚠ **15 issue(s)** across 139 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 66d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-08-11 16:27:44** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
