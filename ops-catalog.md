...
<!-- AUTO:HEALTH_REPORT -->
⚠ **15 issue(s)** across 142 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 69d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-08-14 15:30:09** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
