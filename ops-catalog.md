...
<!-- AUTO:HEALTH_REPORT -->
⚠ **15 issue(s)** across 137 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 61d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-08-06 24:34:51** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
