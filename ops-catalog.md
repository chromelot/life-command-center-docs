...
<!-- AUTO:HEALTH_REPORT -->
⚠ **14 issue(s)** across 111 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 39d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-07-15 14:49:49** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
