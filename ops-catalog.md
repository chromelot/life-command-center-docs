...
### stale (2)
- `context/self/current-priorities.md` — 17d old (threshold 14d)
- `context/systems/operations-catalog.md` — 93d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-09-07 12:36:13** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
