...
### stale (2)
- `context/self/current-priorities.md` — 30d old (threshold 14d)
- `context/systems/operations-catalog.md` — 106d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-09-20 11:49:33** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
