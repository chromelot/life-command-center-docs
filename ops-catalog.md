...
<!-- AUTO:HEALTH_REPORT -->
⚠ **14 issue(s)** across 121 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 44d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-07-20 14:04:03** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
