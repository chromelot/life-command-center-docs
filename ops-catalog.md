...
<!-- AUTO:HEALTH_REPORT -->
⚠ **15 issue(s)** across 145 context files.
...
### stale (1)
- `context/systems/operations-catalog.md` — 70d old (threshold 30d)
...
<!-- AUTO:LAST_GENERATED -->
**2026-08-15 11:11:36** (America/Chicago) — source: `scripts/generate-ops-catalog.mjs`
<!-- /AUTO:LAST_GENERATED -->
