...
- **Three calendars**:
  ...
  - **Time Blocks**: `10283d615faeb91862fc0ccd8f3ac216c7299a58f2196185e912be8f3e3cbe83@group.calendar.google.com` — daily structure goals (movement-first: lift before work, deep work, ops, wind-down 9 PM). One-time overrides per week; recurring series is the fallback template. Full spec → [`time-blocks.md`](time-blocks.md) + [`config/time-blocks.json`](../../config/time-blocks.json).
