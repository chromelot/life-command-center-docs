...
`context/skills/weekly-ops/SKILL.md` — same pattern; ledger steps `1.1`–`1.3`, `2.1`–`2.2`, `3.1`–`8.1`, `9.1` map to named tables (aligned to Dev Projects sub-items under **Create, and Audit Weekly Ops Plan**). Phase 1.3 = daily ops records + ops priority; Phase 9.1 = CL department health on Weekly Ops Log.
